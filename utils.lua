...
function send_api_msg(msg, receiver, text, disable_web_page_preview, markdown)
  ...
  local api_key = '310462516:AAHNPYxzaAIeJXtNLcgAgvUYDqxkoDpkE8w' --Bot Token
  ...
  if res == 400 then
    reply_msg(msg.id, 'Error 400.\nWhat ever that means..\n join my channel : @uiiin', ok_cb, true)
  end
end 
...
function send_api_keyboard(msg, receiver, text, keyboard)
  local api_key = '310462516:AAHNPYxzaAIeJXtNLcgAgvUYDqxkoDpkE8w'
